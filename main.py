...
if __name__ == '__main__':
    ...
    parser.add_argument('--mols_init',  type=str,   default='NSP.txt')
    ...
    parser.add_argument('--objectives', type=str,   default='dock,sim,sim_actual')
    parser.add_argument('--score_wght', type=str,   default=' 1.0, 1.0, 0.0')
    parser.add_argument('--score_succ', type=str,   default=' 0.0, 0.0, 0.0')
    parser.add_argument('--score_clip', type=str,   default=' 0.5, 1.5, 1.0')
